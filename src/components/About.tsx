      ...
      <div className="container mx-auto relative px-4 sm:px-6">
        ...
        <div className="max-w-3xl mx-auto relative">
          ...
          <div className="backdrop-blur-sm bg-white/80 rounded-2xl p-4 sm:p-8 shadow-xl hover:shadow-2xl transition-all duration-300 space-y-4 sm:space-y-6 relative z-10">
            <p className="text-base sm:text-lg text-gray-700 leading-relaxed animate-fade-in">
            ...
            <div className="h-px bg-gradient-to-r from-transparent via-purple-200 to-transparent my-4 sm:my-6" />
            
            <p className="text-base sm:text-lg text-gray-700 leading-relaxed animate-fade-in delay-100">
            ...
            <div className="mt-6 sm:mt-8 flex flex-wrap justify-center gap-2 sm:gap-4">
              <div className="px-3 py-1.5 sm:px-4 sm:py-2 bg-indigo-50 rounded-lg">
                <span className="text-sm sm:text-base text-indigo-600 font-semibold">Python</span>
              </div>
              <div className="px-3 py-1.5 sm:px-4 sm:py-2 bg-purple-50 rounded-lg">
                <span className="text-sm sm:text-base text-purple-600 font-semibold">TensorFlow</span>
              </div>
              <div className="px-3 py-1.5 sm:px-4 sm:py-2 bg-pink-50 rounded-lg">
                <span className="text-sm sm:text-base text-pink-600 font-semibold">SQL</span>
              </div>
            </div>
          </div>
        </div>
